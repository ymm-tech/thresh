...
public class ThreshFlutterActivityAndFragmentDelegate {
    ...
    @Nullable private ThreshFlutterSplashView flutterSplashView;
    @Nullable private ThreshFlutterView flutterView;
    ...
    public ThreshFlutterActivityAndFragmentDelegate(@NonNull Host host) {
        this.host = host;
    }
    ...
    public void setupFlutterEngine() {
        ThreshLogger.v(TAG + "Setting up FlutterEngine.");
        ...
        // FlutterView.
        ThreshLogger.v(TAG + "No preferred FlutterEngine was provided. Creating a new FlutterEngine for"
     ...
     *
     * <ol>
     *   <li>creates a new {@link ThreshFlutterView} in a {@code View} hierarchy
     *   <li>adds a {@link FlutterUiDisplayListener} to it
     *   <li>attaches a {@link FlutterEngine} to the new {@link ThreshFlutterView}
    ...
    public View onCreateView(
        ...
        ThreshLogger.v(TAG + "Creating FlutterView.");
        ensureAlive();
        ...
        flutterSplashView = new ThreshFlutterSplashView(host.getContext());
        ...
        ThreshLogger.v(TAG + "Attaching FlutterEngine to FlutterView.");
    ...
    public void onPostResume() {
        ThreshLogger.v(TAG + "onPostResume()");
        ensureAlive();
        if (flutterEngine != null) {
            ...
            ThreshLogger.v(TAG + "onPostResume() invoked before FlutterFragment was attached to an Activity.");
        }
    }
     ...
     *       lifecycle.
     *   <li>Detaches this delegate's {@link FlutterEngine} from this delegate's {@link ThreshFlutterView}.
     * </ol>
     */
    public void onStop() {
        ThreshLogger.v(TAG + "onStop()");
        ensureAlive();
     ...
     *
     * <p>This method removes this delegate's {@link ThreshFlutterView}'s {@link FlutterUiDisplayListener}.
     */
    public void onDestroyView() {
        ThreshLogger.v(TAG + "onDestroyView()");
        ensureAlive();
    ...
    public void onSaveInstanceState(@Nullable Bundle bundle) {
        ThreshLogger.v(TAG + "onSaveInstanceState. Giving framework and plugins an opportunity to save state.");
        ensureAlive();
    ...
    public void onDetach() {
        ...
        if (host.shouldAttachEngineToActivity()) {
            ...
            ThreshLogger.v(TAG + "Detaching FlutterEngine from the Activity that owns this Fragment.");
    ...
    public void onBackPressed() {
        ensureAlive();
        if (flutterEngine != null) {
            ThreshLogger.v(TAG + "Forwarding onBackPressed() to FlutterEngine.");
            flutterEngine.getNavigationChannel().popRoute();
        } else {
            ThreshLogger.v(TAG + "Invoked onBackPressed() before FlutterFragment was attached to an Activity.");
        }
    }
    ...
    public void onRequestPermissionsResult(
        ...
        ensureAlive();
        if (flutterEngine != null) {
            ThreshLogger.v(TAG + "Forwarding onRequestPermissionsResult() to FlutterEngine:\n"
                            + "requestCode: "
                            + requestCode
                            + "\n"
                            + "permissions: "
            ...
            ThreshLogger.v(TAG + "onRequestPermissionResult() invoked before FlutterFragment was attached to an Activity.");
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ensureAlive();
        if (flutterEngine != null) {
            ThreshLogger.v(TAG + "Forwarding onActivityResult() to FlutterEngine:\n"
                            + "requestCode: "
                            + requestCode
                            + "\n"
                            + "resultCode: "
            ...
            ThreshLogger.v(TAG + "onActivityResult() invoked before FlutterFragment was attached to an Activity.");
        }
    }
    ...
    public void onUserLeaveHint() {
        ensureAlive();
        if (flutterEngine != null) {
            ThreshLogger.v(TAG + "Forwarding onUserLeaveHint() to FlutterEngine.");
            flutterEngine.getActivityControlSurface().onUserLeaveHint();
        } else {
            ThreshLogger.v(TAG + "onUserLeaveHint() invoked before FlutterFragment was attached to an Activity.");
        }
    }
    ...
    public void onTrimMemory(int level) {
        ...
        if (flutterEngine != null) {
            ...
            if (level == TRIM_MEMORY_RUNNING_LOW) {
                ThreshLogger.v(TAG + "Forwarding onTrimMemory() to FlutterEngine. Level: " + level);
    ...
    public void onLowMemory() {
        ThreshLogger.v(TAG + "Forwarding onLowMemory() to FlutterEngine.");
        ensureAlive();
        flutterEngine.getDartExecutor().notifyLowMemoryWarning();
        flutterEngine.getSystemChannel().sendMemoryPressureWarning();
    }
     ...
     */
     public interface Host
        ...
        /**
         * Returns the {@link RenderMode} used by the {@link ThreshFlutterView} that displays the {@link
        ...
        /**
         * Returns the {@link TransparencyMode} used by the {@link ThreshFlutterView} that displays the {@link
         * FlutterEngine}'s content.
         */
        @NonNull
        ...
        /**
         * Returns the {@link FlutterEngine} that should be rendered to a {@link ThreshFlutterView}.
         *
        ...
        /** Invoked by this delegate when its {@link ThreshFlutterView} starts painting pixels. */
        void onFlutterUiDisplayed();

        /** Invoked by this delegate when its {@link ThreshFlutterView} stops painting pixels. */
